...
def records():
    ...
    tree=ttk.Treeview(student_win,columns=("ID","NAME","DOB","AGE","GENDER","CONTACT","EMAIL_ID","ADDRESS","DEGREE","COURSE","JONING DATE","FEES"),show="headings",height=25)
...
imga=Image.open("compp4.jpg")
#imga=imga.resize((1500,350))
phot=ImageTk.PhotoImage(imga)
Label(login_frame,image=phot).pack()

font_but2=font.Font(weight="bold",family="Trebuchet MS",size=33)
x=Label(text="K2 Computer Institute",font=font_but2)
x.config(bg="dark goldenrod",fg="black")
x.place(relx=0.35,rely=0.20)

font_but22=font.Font(weight="bold",family="Trebuchet MS",size=20)
Label(login_frame,text="ADMIN LOGIN",font=font_but22).place(relx=0.43,rely=0.53)
...
frame=Frame(login_frame,width=1500,height=60,bg='dark goldenrod').place(relx=.00,rely=.20)
...
img=Image.open("compp4.jpg")
#img=img.resize((1500,350))
photo=ImageTk.PhotoImage(img)
Label(registration_frame,image=photo).pack()
...
font_but22=font.Font(weight="bold",family="Trebuchet MS",size=20)
Label(registration_frame,text="STUDENT REGISTRATION",font=font_but22).place(relx=0.36,rely=0.50)

frame=Frame(registration_frame,width=1500,height=60,bg='dark goldenrod').place(relx=.00,rely=.20)
...
imgekl=Image.open("compp4.jpg")
#imgekl=imgekl.resize((1500,350))
photool=ImageTk.PhotoImage(imgekl)
Label(student_page,image=photool).pack()
...
font_but22=font.Font(weight="bold",family="Trebuchet MS",size=20)
Label(student_page,text="STUDENT LOGIN",font=font_but22).place(relx=0.43,rely=0.50)

frame=Frame(student_page,width=1500,height=60,bg='dark goldenrod').place(relx=.00,rely=.20)
...
imgekk=Image.open("compp4.jpg")
#imgekk=imgekk.resize((1500,350))
photook=ImageTk.PhotoImage(imgekk)
Label(material_frame,image=photook).pack()
...
font_but22=font.Font(weight="bold",family="Trebuchet MS",size=20)
Label(material_frame,text="MATERIAL ADDING",font=font_but22).place(relx=0.42,rely=0.50)
...
frame=Frame(material_frame,width=1500,height=60,bg='dark goldenrod').place(relx=.00,rely=.20)
